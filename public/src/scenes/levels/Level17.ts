...
export class Level17 extends Phaser.Scene{
    ...
    create(){
        ...
        this.createWindow(Hud, "hud", this.game.renderer.width/2,this.game.renderer.height/2, {level : 17, stars: [24,30,34]});
        ...
        var mapX = this.game.renderer.width/2 - this.bgLayer.width/2 + 250;
