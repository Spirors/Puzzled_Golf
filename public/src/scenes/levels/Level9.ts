...
export class Level9 extends Phaser.Scene{
    ...
    create(){
        ...
        this.createWindow(InGameMenu,"inGameMenu",this.game.renderer.width/2, this.game.renderer.height/2, {level : 9, par: 6});
        this.createWindow(Hud, "hud", this.game.renderer.width/2,this.game.renderer.height/2, {level : 9, par: 6});
