...
export class Level7 extends Phaser.Scene{
    ...
    create(){
        ...
        this.createWindow(InGameMenu,"inGameMenu",this.game.renderer.width/2, this.game.renderer.height/2, {level : 7, par: 7});
        this.createWindow(Hud, "hud", 0, 0, {level : 7, par: 7});
