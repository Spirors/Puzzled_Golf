...
export class Level11 extends Phaser.Scene{
    ...
    create(){
        ...
        this.createWindow(InGameMenu,"inGameMenu",this.game.renderer.width/2, this.game.renderer.height/2, {level : 11, par: 13});
        this.createWindow(Hud, "hud", this.game.renderer.width/2,this.game.renderer.height/2, {level : 11, par: 13});
